function Contact() {
    return (
        <section className="bg-rose-500 dark:bg-gray-900 min-h-screen">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md animate-slide-in-bottom">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-900 dark:text-gray-400 sm:text-xl p-3">
                    Got a technical issue? Want to send feedback about my portofolio? Need details about our me? Please Let me know, Thankyou🤞.
                </p>
