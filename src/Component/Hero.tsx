...
function Hero() {
    return (
        <div className="hero min-h-screen relative flex items-center justify-center">
            ...
            <div className="hero-content text-neutral-content relative z-20 flex flex-col justify-center items-center w-full p-4">
                ...
                <p className="mb-5 text-center text-sm md:text-base w-full md:w-2/3 lg:w-1/2 fade-in">
