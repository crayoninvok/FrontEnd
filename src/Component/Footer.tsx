...
function Footer() {
    return (
        <footer className="flex flex-col items-center bg-rose-500 py-4 border-t-2 border-black w-full ">
            ...
            <div className="text-xs md:text-sm lg:text-base w-full bg-rose-500 text-center py-2">
